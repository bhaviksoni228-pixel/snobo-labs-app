...
const GREETING: Msg = {
  role: 'assistant',
  content:
    "Hey, I'm Snobo 👋 Ask me anything about our services, pricing, or where to find something on the site.",
}
...
export default function ChatWidget() {
  ...
  // Never show the chatbot anywhere in the admin panel.
        ...
        <div className="fixed bottom-24 right-5 z-[60] w-[90vw] max-w-[360px] h-[70vh] max-h-[520px] bg-black border border-grey-2 rounded-2xl flex flex-col overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
          ...
          <div className="flex items-center gap-3 px-4 py-3.5 border-b border-grey-2">
            ...
            <div>
              ...
              <div className="text-[11px] text-grey-4">
          ...
          <form
            onSubmit={handleSend}
            className="flex items-center gap-2 p-3 border-t border-grey-2"
          >
            <input
              value={input}
