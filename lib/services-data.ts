...
export const SERVICES_DATA: Record<string, ServiceData> = {
  sites: {
    slug: 'sites',
    name: 'Snobo Sites',
    hook: 'Get a professional website',
    description:
      'A fast, mobile-friendly website that actually represents your business — built and live in days, not months.',
    features: [
      'Mobile-responsive design',
      'Contact form wired to your email',
      'Basic SEO setup',
      'Admin-editable content (Standard & Premium)',
    ],
    howItWorks: [
      'We set it up — share your business details and preferences',
      'We build it — live draft ready within days',
  ...
  chat: {
    slug: 'chat',
    name: 'Snobo Chat',
    hook: 'Never miss a customer message again',
    description:
      'An AI chatbot for your website and WhatsApp — replies instantly, even while you sleep. Think of it as hiring a 24/7 support teammate.',
    features: [
      'Website chat widget',
      'WhatsApp AI agent',
      'Trained on your business info and FAQs',
      'Monthly retraining and monitoring (retainer)',
    ],
    howItWorks: [
      'We learn your business — products, FAQs, tone',
      'We train and deploy the AI agent',
  ...
  crm: {
    slug: 'crm',
    name: 'Snobo CRM',
    hook: 'Stop losing track of customers',
    description:
      'A simple, WhatsApp-native system to see every lead, get follow-up reminders, and never forget a conversation again.',
    features: [
    ...
    howItWorks: [
      'We map your current sales process',
      'We build your CRM around WhatsApp + a simple dashboard',
  ...
  bots: {
    slug: 'bots',
    name: 'Snobo Bots',
    hook: 'Automate the repetitive stuff',
    description:
      'Add-on bots that handle bookings, FAQs, and follow-ups automatically — layered on top of Snobo Chat.',
    features: [
      'Booking / appointment bot',
      'Lead qualification bot',
      'Order bots and voice agents (coming soon)',
    ],
    howItWorks: [
      'Choose which bot fits your business',
      'We configure it around your existing calendar/process',
  ...
  build: {
    slug: 'build',
    name: 'Snobo Build',
    hook: 'Turn your idea into a working product',
    description:
      'Full MVP development for founders — website plus whichever AI/CRM pieces you need, bundled and built fast, direct from the person coding it.',
    features: [
      'Full-stack MVP build',
      'Website + core product features',
      'Optional AI/CRM pieces bundled in',
      'Direct access to the builder throughout',
    ],
    howItWorks: [
      'We scope exactly what your MVP needs',
      'We build it end-to-end, fast',
